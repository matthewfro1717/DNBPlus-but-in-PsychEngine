...
floaters = {'dave-angey', 'bambi-3d', 'bambi-3d-playable', 'expunged', 'bambi-unfair', 'exbungo', 'dave-festival-3d', 'dave-3d-recursed', 'bf-3d', 'dave-furiosity', 'oppositionexpunged', 'cockey-old', 'cockey', 'cockey-v2', 'piss', 'pissey-v2', 'poop', 'pooper-v2', 'shartey'}
exclude = {'expunged', 'dave-furiosity', 'dave-angey', 'dave-angey-playable', 'bambi-3d', 'bambi-3d-playable', 'bambi-unfair', 'oppositionexpunged', 'cockey-old', 'cockey', 'cockey-v2', 'piss', 'pissey-v2', 'poop', 'pooper-v2', 'shartey'} --only apply the 3d notes
shitters = {}  
elapsedTime = 0
function onCreate()
  luaDebugMode = true
